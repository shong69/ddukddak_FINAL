...
//				
////		게시글 이미 추가
//		registry.addResourceHandler(boardResourceHandler).addResourceLocations("files:///" + classPath + "/board/");
//		
////		기타 메인 이미지
//		registry.addResourceHandler("/images/**").addResourceLocations("clsspath:/static/images/");
//		
//	}
//	
//	
