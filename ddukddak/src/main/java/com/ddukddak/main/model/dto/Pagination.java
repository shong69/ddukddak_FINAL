package com.ddukddak.main.model.dto;
...
public class Pagination {
	...
	private void calculate() {
		...
		// 한 페이지에 게시글이 10개씩 보여질 경우 == limit 이 10일 경우
		// ex) 게시글 수 : 95개 -> 10 페이지
		//     게시글 수 : 100개 -> 10 페이지
		//	   게시글 수 : 101개 -> 11 페이지
		...
		// 페이지 번호 목록이 10개씩 보여질 경우 == pageSize 가 10일 경우
		// 현재 페이지가 1 ~ 10 : startPage는 1
		// 현재 페이지가 11 ~ 20 : startPage는 11
		startPage = (currentPage - 1) / pageSize * pageSize + 1;
		
		// endPage : 페이지 번호 목록의 끝 번호
		// 현재 페이지가 1 ~ 10 : 10 페이지
		// 현재 페이지가 11 ~ 20 : 20 페이지
