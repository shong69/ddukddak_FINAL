...
ALTER TABLE ORDER_DETAIL ADD CART_ID NUMBER;

		SELECT O.MERCHANT_UID, ORDER_DATE, D.ORDER_STATUS, ORDER_DEL_FL, D.ORDER_ITEM_NO, ORDER_QUANTITY, ORDER_PRICE, D.PRODUCT_NO,P.PRODUCT_NAME, 
		...
		AND O.STATUS = 'paid'
		GROUP BY 
		    O.MERCHANT_UID, O.ORDER_DATE, D.ORDER_STATUS, O.ORDER_DEL_FL, 
